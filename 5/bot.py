...
class ChatBot:
    def __init__(self):
        ...
        try:
            self.model = joblib.load("bot_model.joblib")
        except:
    ...
    def predict_intent(self, text):
        ...
        return intent if proba > 0.4 else "unknown"
    ...
    def process(self, message: str):
        ...
        if self.state == DialogState.WAIT_CITY:
            ...
            if intent == "weather":
                ...
                response = "Привет! Я твой умный бот. Чем помочь?"

            elif intent == "goodbye":
                response = "До свидания! Буду ждать тебя снова."
                ...
                if not found_pattern:
                    response = "Я не совсем понял. Можешь спросить про погоду или поздороваться."
